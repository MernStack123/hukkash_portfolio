...
// 		year: "2025",
// 		video:
// 			"https://framerusercontent.com/assets/CY8Qwr1FNoEc9Xx7LipyOpb2PM.mp4",
// 	},
// 	{
// 		title: "Dream in motion",
// 		subtitle: "Documentary",
...
// 				layout === "one"
// 					? "pt-0 pb-0 cursor-dot"
// 					: "pt-40 pb-10 md:pt-44 md:pb-14"
// 			} px-4 md:px-36`}
// 		>
// 			<div className="flex flex-col gap-8 md:gap-14">
// 				<h1 className="text-[#fff] text-center font-bebas font-[400] text-7xl tracking-[1px] md:text-[150px]">
// 					All Videos
// 				</h1>
...
// 					} ${
// 						layout === "one"
// 							? "snap-y snap-mandatory overflow-y-scroll h-screen md:h-[calc(100vh)] scrollbar-none"
// 							: ""
// 					}`}
// 				>
// 					{items.map((item, index) => (
...
// 								playsInline
// 								className={`w-full h-full object-cover rounded-xl md:rounded-2xl transition-transform duration-300 group-hover:scale-110 ${
// 									layout === "one" ? "md:h-full" : "md:h-[350px]"
// 								}`}
// 							/>
// 						</div>
// 					))}
